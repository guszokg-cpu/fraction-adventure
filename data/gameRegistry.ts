...
export const GAME_REGISTRY: LessonGames[] = [
  {
    ...
    games: [
      { id: "witchcake", emoji: "📐", title: "แม่มดน้อยแบ่งเท่า ๆ กัน", desc: "แม่มดเสกเค้กกลม กระดาษสี่เหลี่ยมจัตุรัส และกระดาษผืนผ้ามา 3 แบบ เลือกอันที่แบ่งเท่ากันจริง — สอนว่าเศษส่วนต้องแบ่งเท่ากันก่อนเสมอ ทั้งรูปวงกลมและการพับกระดาษ", concept: "ส่วนแบ่งต้องเท่ากัน (วงกลม/กระดาษ)", accent: "from-violet-500 to-fuchsia-500", ready: true },
      ...
      { id: "paperfold", emoji: "✂️", title: "พับกระดาษแบ่งเท่า ๆ กัน", desc: "เลือกกระดาษจัตุรัส/ผืนผ้า เลือกสี กดพับเข้า-กางออกเห็นรอยพับจริง แล้วใช้กรรไกรตัดเป็นส่วนเท่า ๆ กัน แตะระบายสีอ่านเป็นเศษส่วน — โหมดครู + โหมดสุ่มถามตอบ", concept: "แบ่งกระดาษเป็นส่วนเท่ากัน (พับ-ตัด)", accent: "from-rose-500 to-amber-500", ready: true },
    ],
  },
  {
    slug: "read-write",
